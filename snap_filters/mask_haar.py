...
eye_detector=cv2.CascadeClassifier('Haar_Classifier/haarcascade_eye_tree_eyeglasses.xml')
face_detector = cv2.CascadeClassifier('Haar_Classifier/haarcascade_frontalface_default.xml')

#feed = cv2.imread('face.jpg')
mask = cv2.imread('images/wrmask.png ',cv2.IMREAD_UNCHANGED)
